...
// ── Sub-components ─────────────────────────────────────────────────────────
const StatBadge = ({ icon: Icon, label, value, color }: StatBadgeProps) => (
...
const LoginPage = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          'radial-gradient(ellipse 80% 80% at 50% -20%, rgba(120,50,255,0.25) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 110%, rgba(6,182,212,0.2) 0%, transparent 60%), #08080f',
      }}
    >
      <ParticleBackground />
      ...
      >
        ...
        <div className="w-full md:w-[48%] flex flex-col justify-center p-9 md:p-14">
          ...
          <motion.form {...fadeUp(0.2)} onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer group">
                <div className="relative w-4 h-4">
                  ...
                  <div
                    className="w-4 h-4 rounded-md border peer-checked:border-transparent transition-all"
            ...
            <motion.button
              ...
              style={{
                ...
                boxShadow: isLoading
                  ? 'none'
                  : '0 0 28px rgba(139,92,246,0.4), 0 4px 20px rgba(6,182,212,0.2)',
          ...
          <motion.div {...fadeUp(0.35)} className="flex items-center gap-4 my-7">
            ...
            <span className="text-[11px] uppercase tracking-widest font-medium text-white/25">
              or continue with
            </span>
            <div className="h-px flex-1" style={{ background: 'rgba(255,255,255,0.07)' }} />
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-white/45 leading-relaxed">
                Analyzes code diffs in real-time, detects security vulnerabilities, and posts AI-generated fix
                suggestions directly to your GitHub PRs.
              </p>
